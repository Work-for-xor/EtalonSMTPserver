    ...
    while cocl < len(cl_for_mail):
        try:
            ...
            try:
                ...
                print(f'\033[0;1;92m' + "    Successful: " + me + " to " + cl_for_mail[cocl][6] + "  " +
                      cl_for_mail[cocl][1] + '\033[0m')
                ...
                if global_params.cointer_sended_mail == 200000:
            ...
            print('\x1b[31m' + me + "   Ошибка отправки кривой контакт !!!" + '\033[0m')
...
def load_params():
    try:
        ...
        f_contact_list_all = open(os.getcwd() + '/tosend.csv', 'r')
